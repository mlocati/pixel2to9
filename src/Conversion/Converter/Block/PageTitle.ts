...
export default class PageTitle extends Block implements Converter
{
    public convert(doc: XMLDocument, warnings: string[]): void
    {
        this.processconvertBlockTemplates(doc, 'page_title', {
            ...
            pixel_fancy_title_emphasis: {newTemplate: '', warning: 'The pixel_fancy_title_emphasis custom template of the Page Title block is deprecated'},
            ...
            pixel_plain: {newTemplate: '', warning: 'The pixel_plain custom template of the Page Title block is deprecated'},
        }, warnings);
    }
}
